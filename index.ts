class PersianDate {
  ...
  fullDateSignReplace(sign : string) {
    this.fullDate = this.fullDate!.replaceAll(/["/"]/g, `${sign}`);
  }

  private covertToEnglishDigits(argument : any) {
    return argument
  ...
  mounth: string | null = null;
  day: string | null = null;
  fullTime: string | null = null;
  hour: string | null = null;
  minute: string | null = null;
  second: string | null = null;
  note: string | null = "All good!";
  
}
let date = new PersianDate(true, "24H");
